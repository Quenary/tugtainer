...
export const ESettingSortIndex: { [K in ESettingKey]: number } = {
  ...
  [ESettingKey.PULL_BEFORE_CHECK]: 3,
  [ESettingKey.UPDATE_ONLY_RUNNING]: 4,
  [ESettingKey.NOTIFICATION_URLS]: 5,
  [ESettingKey.NOTIFICATION_TITLE_TEMPLATE]: 6,
  [ESettingKey.NOTIFICATION_BODY_TEMPLATE]: 7,
};
